...
class Ui_ingresoDatos(object):
    def setupUi(self, ingresoDatos):
        ...
        self.lblTitulo.setGeometry(QtCore.QRect(530, 10, 161, 51))
        font = QtGui.QFont()
        font.setFamily("Berlin Sans FB")
        ...
        self.label_6.setGeometry(QtCore.QRect(550, 90, 251, 16))
        self.label_6.setObjectName("label_6")
        self.txtPtoPartida = QtWidgets.QLineEdit(self.centralwidget)
        self.txtPtoPartida.setGeometry(QtCore.QRect(810, 90, 113, 20))
        font = QtGui.QFont()
        font.setFamily("Berlin Sans FB")
        font.setPointSize(11)
        font.setUnderline(False)
        ...
        ingresoDatos.setTabOrder(self.txtPtoPartida, self.btnSimular)
        ingresoDatos.setTabOrder(self.btnSimular, self.txtTiempo)
        ingresoDatos.setTabOrder(self.txtTiempo, self.tablaSimVolun)
        ingresoDatos.setTabOrder(self.tablaSimVolun, self.tablaSimCall)
        ingresoDatos.setTabOrder(self.tablaSimCall, self.txtGanCall)
        ingresoDatos.setTabOrder(self.txtGanCall, self.txtGanVol)
